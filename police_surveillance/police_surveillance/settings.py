...
SECRET_KEY = "django-insecure-=jqi@p1zy(=%1jiwsjehf%%gi+hep2fv@n$xy410(glv7660dg"
...
WSGI_APPLICATION = "police_surveillance.wsgi.application"

ASGI_APPLICATION = "police_surveillance.asgi.application"
